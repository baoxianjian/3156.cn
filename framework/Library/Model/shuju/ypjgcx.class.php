...
*/
class Model_shuju_ypjgcx extends Base_model{
    //@override
    ...
    public function setTableName() {
        $this->_tableName = 'data_yaojia'; //设置表名
    	    ...
    	    if(count($srow)>0)
    	      {
	    	   	 ...
	    	   	 if($cankaojia=intval($srow['cankaojia'])){
	    	   		$condition.=" AND `cankaojia` >= '$cankaojia' and `cankaojia` <= '$cankaojia'";
	    	   	 }
