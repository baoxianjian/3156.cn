...
*/
class Model_news_keys extends Base_model{
    //@override
    public function setPrimaryKey() {
        $this->_PK = 'key_id';//设置主键
    }
    //@override
    public function setTableName() {
        $this->_tableName = 'news_keywords'; //设置表名
    ...
    */
    ...
    {
        $condition = $srow; //查询条件
        return $this->getList($condition,array('*'),array('key_id'=>'desc'),$page);
    }
