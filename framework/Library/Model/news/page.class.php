...
*/
class Model_news_page extends Base_model{
    //@override
    ...
    public function setTableName() {
        $this->_tableName = 'news_page'; //设置表名
    ...
    */
    public function getListAll($page,$condition){
        return $this->getList($condition,array('*'),array($this->_PK=>'desc'), $page , $limit=10,true);
    }
    ...
    */
	...
	public function updateRowByRow($row = array(),$srow = array())
    {
        if(!$row) return false;
		if(!$srow) return false;
		return $this->update($srow,$row);
        //return $this->delete(array($this->_PK=>$id));
    }
    ...
    * @return array|false
    */
    public function getRowByRow($row){
        if(!$row){return false;}
    ...
    */
    public function getRowsetAll($srow=array(),$count=10)
    {
        ...
        */
        ...
        $fields="n.news_id,n.admin_id,n.title,n.static_url, n.pic, n.description, n.type_id1,n.type_id2,n.type_id3,
