...
*/
class Model_ill_disease extends Base_model{
    //@override
    ...
    public function setTableName() {
        $this->_tableName = 'ill_disease'; //设置表名
    ...
    * @return array|false
    */
    public function getListAll($page, $condition, $files = array('*')){
        return $this->getList($condition, $files, array('order'=>'desc'), $page, $limit=10, true);
    }
