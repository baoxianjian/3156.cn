...
class SImagelib {
	 ...
	 * @return	void
	 */
	function SImagelib($props = array())
	{
		if (count($props) > 0)
		{
	...
	//Add by Lany
	public function addWM($imgPath){
		$fontfile = dirname(__FILE__) . '/captcha/fonts/VeraSansBold.ttf';
		$config['source_image'] = $imgPath;
		$config['wm_text'] = 'Copyright 2011 - ShenM.cn';
		$config['wm_type'] = 'text';
		$config['wm_font_path'] = $fontfile;
