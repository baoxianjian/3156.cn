...
class CI_Xmlrpc {
	...
	/* add */
	var $baseAuthUse = false;
	var $baseAuthUsername 	= '';
	var $baseAuthPassword 	= '';
...
class XML_RPC_Client extends CI_Xmlrpc
{
	...
	function sendPayload($msg)
	{
		...
		if($this->baseAuthUse) {
			$op .= "Authorization: Basic ".base64_encode($this->baseAuthUsername.':'.$this->baseAuthPassword)."$r";
		}
