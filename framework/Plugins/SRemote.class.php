...
class SRemote{ 
    ...
    public static function getHtmlContent($url)
    {
        ...
        $content= self::getRemoteContent($url); 
    ...
    public static function getCurlContent($url,$ch=false,$close=true)
    {
        if(!$ch)
        {
            $ch = curl_init();
        }
        curl_setopt($ch, CURLOPT_URL,$url);//get请求api
       ...
       // curl_setopt($ch, CURLOPT_TIMEOUT,  10);
        ...
        $rc = curl_exec($ch);//remote content
