...
$(function(){
	...
	$('.bao .type').map(function(index, element) {
       $(this).click(function(e) {
		if($(this).hasClass('type_active')){
			$(this).css('color','#333333').css('background','#fff');
			$(this).removeClass('type_active');
		}
		else{
			$('.bao .type').removeClass('type_active').css('color','#333333').css('background','#fff');
			$(this).addClass('type_active');
			$(this).css('color','#fff').css('background','#fb8200');
			
			/*$(".bao .type").removeAttr("name");
			$(this).attr("name","row[pdt_type1]");*/
		}
