...
*/        
class Controller_need extends Controller_basepage {
	//首页
	function pageList($inPath){
        ...
        foreach($data['list'] as $key=>$value){
            ...
            $list[$key]['del_url']=$url=SRoute::createUrl('need/del', array('page' => $page,'id'=>$value['id'],'t'=>$value['type']), $this->request);
            $list[$key]['rec_url']=$url=SRoute::createUrl('need/rec', array('page' => $page,'id'=>$value['id'],'t'=>$value['type']), $this->request);
        ...
        $param[PAGE_VAR_NAME] = $this->pageBar($data['count'], $page, $inPath,30,'style1',true);
